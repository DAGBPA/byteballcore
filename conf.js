...
/*
There are 3 ways to customize conf in modules that use dag-pizza-dough lib:
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'dagpizza';
	exports.database.user = exports.database.user || 'dagpizza';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'dagpizza-light.sqlite' : 'dagpizza.sqlite');
}
