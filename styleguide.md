...
This document defines the code style rules for all DAG Pizza projects, i.e. all projects under https://github.com/DAGBPA, not just this repo dag-pizza-dough.
